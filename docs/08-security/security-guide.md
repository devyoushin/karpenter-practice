...
- [공식문서 - Security](https://karpenter.sh/docs/reference/08-security/)
- [AWS IMDSv2](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configuring-instance-metadata-service.html)
- [EKS Best Practices Guide - Security](https://aws.github.io/aws-eks-best-practices/08-security/docs/)
