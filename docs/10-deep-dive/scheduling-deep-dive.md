...
- [공식문서 - Scheduling](https://karpenter.sh/docs/concepts/04-scheduling/)
...
- 관련 가이드: `docs/04-scheduling/topology-spread-guide.md`, `docs/03-core/multi-nodepool-guide.md`, `docs/10-deep-dive/architecture-deep-dive.md`
