...
> 자세한 내용은 `docs/05-cost/spot-guide.md` 참고
...
> 자세한 내용은 `docs/05-cost/consolidation-guide.md` 참고
...
> 자세한 내용은 `docs/05-cost/graviton-guide.md` 참고
...
- 관련 가이드: `docs/05-cost/spot-guide.md`, `docs/05-cost/consolidation-guide.md`, `docs/07-operations/disruption-guide.md`, `docs/05-cost/graviton-guide.md`, `docs/03-core/multi-nodepool-guide.md`
