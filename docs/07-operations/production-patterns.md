...
- [공식문서 - IAM 설정](https://karpenter.sh/docs/02-getting-started/getting-started-with-karpenter/)
- 관련 가이드: `docs/07-operations/disruption-guide.md`, `docs/10-deep-dive/disruption-deep-dive.md`, `docs/05-cost/cost-optimization-guide.md`
